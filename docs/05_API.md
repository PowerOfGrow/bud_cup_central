...
- `photo_url` (text) : URL de la photo principale (1 photo par entrée)
...
- `aroma_score` (numeric) : Score aromatique et terpénique (0-100)
- `taste_score` (numeric) : Score goût (0-100)
- `effect_score` (numeric) : Score effet (0-100)
- `overall_score` (numeric) : Score global (moyenne des 4 critères ci-dessus)
- `notes` (text) : Notes et commentaires du juge
