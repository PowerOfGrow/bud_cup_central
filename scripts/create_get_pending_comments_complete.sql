-- Script SQL COMPLET à copier-coller dans Supabase SQL Editor
-- Crée la fonction get_pending_comments_for_organizer avec toutes les permissions

-- Étape 1: Supprimer la fonction si elle existe déjà
...
-- Étape 4: Donner la permission d'exécution aux utilisateurs authentifiés
grant execute on function public.get_pending_comments_for_organizer(text) to authenticated;

-- Étape 5: Vérifier que la fonction a été créée (optionnel)
