      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-accent/10 backdrop-blur-sm border border-accent/30 rounded-full px-6 py-2 mb-8 animate-fade-in hover:border-accent/50 hover:scale-105 transition-all duration-300 cursor-pointer group">
            ...
            <span className="text-sm font-medium text-foreground">Plateforme de Compétition CBD Premium</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight animate-fade-in delay-200">
          ...
          {/* Subheading */}
          <p className="text-xl md:text-2xl text-foreground/90 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in delay-500">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in delay-700">
            ...
            <Button 
              ...
              variant="outline" 
              asChild
              className="border-accent text-foreground hover:bg-accent/10 text-lg px-8 py-6 hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="bg-card/10 backdrop-blur-sm border border-accent/20 rounded-xl p-6 hover:shadow-gold transition-all duration-500 hover:scale-110 hover:border-accent/50 group cursor-pointer">
              ...
              <div className="text-3xl font-bold text-foreground mb-1 bg-gradient-gold bg-clip-text text-transparent">500+</div>
              <div className="text-sm text-foreground/70">Entrées Jugées</div>
            </div>
            <div className="bg-card/10 backdrop-blur-sm border border-accent/20 rounded-xl p-6 hover:shadow-gold transition-all duration-500 hover:scale-110 hover:border-accent/50 group cursor-pointer">
              <Users className="h-8 w-8 text-accent mx-auto mb-3 group-hover:scale-110 transition-transform duration-300" />
              <div className="text-3xl font-bold text-foreground mb-1 bg-gradient-gold bg-clip-text text-transparent">200+</div>
              <div className="text-sm text-foreground/70">Producteurs</div>
            </div>
            <div className="bg-card/10 backdrop-blur-sm border border-accent/20 rounded-xl p-6 hover:shadow-gold transition-all duration-500 hover:scale-110 hover:border-accent/50 group cursor-pointer">
              <TrendingUp className="h-8 w-8 text-accent mx-auto mb-3 group-hover:scale-110 transition-transform duration-300" />
              <div className="text-3xl font-bold text-foreground mb-1 bg-gradient-gold bg-clip-text text-transparent">50+</div>
              <div className="text-sm text-foreground/70">Jurés Experts</div>
            </div>
          </div>
        </div>
      </div>
