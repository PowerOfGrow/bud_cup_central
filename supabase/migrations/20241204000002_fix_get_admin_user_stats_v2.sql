-- Fix v2: Version simplifiée de get_admin_user_stats
-- Retour à la fonction originale avec seulement des améliorations de gestion NULL
...
comment on function public.get_admin_user_stats is 'Statistiques détaillées par utilisateur pour la page Admin - Version simplifiée avec gestion des NULL améliorée';
