-- Fix v7: Version complète avec toutes les statistiques
-- Basée sur la version minimale qui fonctionne
...
begin
  ...
  select
    p.id,
    p.display_name,
    ''::text as email,  -- Email récupéré séparément si nécessaire
    p.role,
    p.created_at,
...
comment on function public.get_admin_user_stats is 'Statistiques détaillées par utilisateur pour la page Admin - Version complète avec toutes les statistiques';
