-- Fix v9: Version finale complète avec toutes les fonctionnalités
-- Basée sur la version incrémentale qui fonctionne
...
comment on function public.get_admin_user_stats is 'Statistiques détaillées par utilisateur pour la page Admin - Version finale complète avec toutes les fonctionnalités';
