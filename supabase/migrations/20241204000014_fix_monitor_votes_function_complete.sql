-- Fix v4: Version complète avec statistiques simplifiées
-- Les statistiques seront calculées côté client pour éviter les sous-requêtes complexes
...
begin
  ...
  select
    ...
    -- Statistiques à 0 pour l'instant, calculées côté client si nécessaire
...
comment on function public.get_suspicious_votes_for_organizer is 'Récupère les votes suspects pour les organisateurs - Version complète avec statistiques calculées par boucle';
